...
export function formatGroupReason(reason: string, matchedPositions: number[]) {
...
export function formatRoundReason(reason: string, matchedTeams: string[]) {
...
export function formatExtraReason(reason: string) {
...
export function getReasonTone(reason: string) {
  if (reason === 'exact-score') {
    return 'exact'
  }
...
export function formatPositionsMeta(positions: number[]) {
...
export function formatTeamsMeta(teams: string[]) {
  if (teams.length === 0) {
    return ''
  }
